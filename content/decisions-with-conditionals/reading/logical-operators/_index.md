...
The operators `&` [Bitwise AND (&)](http://localhost:8081/devdocs_en_javascript_2025-01/operators/bitwise_and) and `|` [Bitwise OR (|)](http://localhost:8081/devdocs_en_javascript_2025-01/operators/bitwise_or) are bitwise operators, which are beyond the scope of this course.
...
The following table lists operators in order of precedence, from highest (applied first) to lowest (applied last). A complete table for the entire language can be found in the [MDN JavaScript Documentation](http://localhost:8081/devdocs_en_javascript_2025-01/operators/operator_precedence#table).
