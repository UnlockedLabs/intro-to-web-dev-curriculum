...
The response to the GET request is contained in a `Response` object, which is an instance of the [Response class](http://localhost:8081/devdocs_en_dom_2025-01/response).
